...
$message_title = "Reject Appointment Request";
$message_body = "" . $ss['first_name'] . " reject your appointment request.";
...
if ($r) {
	echo '<h1>You reject ' . $rs['first_name'] . '\'s appointment request !</h1>';
} else {
