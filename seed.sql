...
INSERT INTO times (begins_date, begins_time, ends_time, tag, user_id) VALUES (CURDATE() - INTERVAL FLOOR(RAND()*300) DAY, CONCAT(1 + FLOOR(RAND()*20), ':00'), CONCAT(1 + FLOOR(RAND()*20), ':00'), 'aaa', 1 + FLOOR(RAND()*4));
INSERT INTO times (begins_date, begins_time, ends_time, tag, user_id) VALUES (CURDATE() - INTERVAL FLOOR(RAND()*300) DAY, CONCAT(1 + FLOOR(RAND()*20), ':00'), CONCAT(1 + FLOOR(RAND()*20), ':00'), 'aaa', 1 + FLOOR(RAND()*4));
INSERT INTO times (begins_date, begins_time, ends_time, tag, user_id) VALUES (CURDATE() - INTERVAL FLOOR(RAND()*300) DAY, CONCAT(1 + FLOOR(RAND()*20), ':00'), CONCAT(1 + FLOOR(RAND()*20), ':00'), 'aaa', 1 + FLOOR(RAND()*4));
INSERT INTO times (begins_date, begins_time, ends_time, tag, user_id) VALUES (CURDATE() - INTERVAL FLOOR(RAND()*300) DAY, CONCAT(1 + FLOOR(RAND()*20), ':00'), CONCAT(1 + FLOOR(RAND()*20), ':00'), 'aaa', 1 + FLOOR(RAND()*4));
INSERT INTO times (begins_date, begins_time, ends_time, tag, user_id) VALUES (CURDATE() - INTERVAL FLOOR(RAND()*300) DAY, CONCAT(1 + FLOOR(RAND()*20), ':00'), CONCAT(1 + FLOOR(RAND()*20), ':00'), 'aaa', 1 + FLOOR(RAND()*4));
